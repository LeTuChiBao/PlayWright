exports.DynamicTablePage = class DynamicTablePage{
    ...
    async navigationToDynamicTablePage(){
    ...
    async getChromeCpuPercentage(){
        let chromCpuPercentage = await this.getChromeCellContent(await this.getHeaderCPUIndex())
        return `Chrome CPU: ${chromCpuPercentage}`
    }
